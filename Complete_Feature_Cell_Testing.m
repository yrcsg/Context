function Feature_Cell=Complete_Feature_Cell_Testing(All_Object_List,Index_resolution,image_index,Num_m,Prior_Co_Occur_Conditional_Prob,Prior_Scale_Histogram,...
