...
for i=1:Num_training
    ...
    for j=1:Num_Object
        ...
        image_index=index;
        % if GT_Label is BG or thie GT_Label is not in the interesting list
...
save Complete_Cell_Features.mat Cell_Features
save('Complete_Cell_Features.mat','Cell_Features','-v7.3');