...
function Cell_Scale_GMM_400=ScaleGMM(Total_list)
...
Feature_Cell=Cell_Scale_GMM_Training_Testing;
...
Cell_Scale_GMM_Threhold=Feature_Cell(Total_list',:);
Num_Samples=size(Cell_Scale_GMM_Threhold,1);

for i=1:Num_Samples
    Cell_Scale_GMM_Threhold{i,1}=find(SampleNum_Threshold==Cell_Scale_GMM_Threhold{i,1});
    Cell_Scale_GMM_Threhold{i,2}=Cell_Scale_GMM_Threhold{i,2}(SampleNum_Threshold);
end

Cell_Scale_GMM_400=Cell_Scale_GMM_Threhold;
