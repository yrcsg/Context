function [W_new] = Complete_lsvmTrain(Num_M,cls_index_32,GC,W_dim,sampNegWholeNum,Console_out_path,cls,libsvm_dir,model_dir,Feature_path,numRelabel,numDataMine,Init_W,latent)
...
%         tic
        ...
        %%%%%%%%%%%
        tic
        [negMineFeatures] = Complete_mineHard_detect_all(cls_index_32,latent,W, Num_M, Whole_Features, negSampWholeIdx);
        toc
